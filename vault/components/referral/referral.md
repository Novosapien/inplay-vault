...
| Admin (InPlay client-side) | ✎ **Group creation and editing, and share-code editing** (01-09-2026, committed by Hasan). Today only Edwin has access to the trading admin panel; Cody has none | Being added as an extra section on the existing **trading admin panel** rather than a new tool. Cody's reason: _"I would like to ping you less and be able to sort on our time zone."_ Source: [[01-09-2026-touchdown]] |
...
| 2026-09-01 | **Client-side admin access to groups and share codes committed.** Cody asked whether the promised editing would live in the admin panel he already uses; Hasan confirmed it goes on the **trading admin panel** as an extra section: create groups, edit groups, edit share codes. ⚠ **Cody has no access to that panel today, only Edwin does**, so an access grant is part of the work, not just the feature. The motive is timezone independence rather than capability: Cody wants to stop pinging Hasan for changes he could make himself. | [[01-09-2026-touchdown]] |
