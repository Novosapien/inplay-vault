...
| `ios-video-gamecast` | Native advanced | Media type: VIDEO | 1 | `ca-app-pub-2057484236798641/8819125414` |
...
| `and-video-gamecast` | Native advanced | Media type: VIDEO | 1 | `ca-app-pub-2057484236798641/2249897963` |
...
- Format **confirmed in the AdMob console (17 August 2026)** as native advanced with media type VIDEO on both platforms. That is the format that lets the creative render inside an InPlay-designed container rather than taking over the screen, so the in-field Gamecast placement is viable on format grounds.
