...
| **[[information-layer/information-layer\|Information / Bloomberg Terminal]]** | The data and intelligence layer -- the main stage of the app. Covers "Discover -> See -> Understand -> Decide" user journey | Six sub-components: Discovery/Home, Game Day Overview, Single Game Page, Team Page, Research Tab (**Defined 26-06**, 3-tier paid build: pre-canned → saved-custom → AI companion; 99c→$14.99→$49.99 tiers, in-app payment; **22-07 subscription pricing set: Research $49.99/mo, Watch/Pro-View $49.99/mo, bundle $79.99/mo, monthly, ads still run**), Leaderboard. Consumes SR (sports data, match tracker, news) + T0 (prices, order book). Owns the cross-correlated volatility dataset (SR events x T0 prices). News feed, block trade alerts, leaderboards (3 verticals x 4 time horizons), proximity alerts | Defined |
