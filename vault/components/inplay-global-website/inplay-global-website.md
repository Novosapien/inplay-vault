...
> **Update (12–17 June touchdowns):** **Press / media page signed off (12-06)** and integrated. **Screenshots later (12-06):** the main site still needs **app screenshots** and visual refinement in a later pass; current focus is getting the bulk of the structure and copy in place first. **Analytics (12-06):** **Microsoft Clarity** heat-mapping (session recording, scroll/click heat maps, dwell time) is to be added across the websites, alongside Google Analytics on the rebuilt Challenge Website (see [[challenge-website/challenge-website]] and the Analytics & Funnel Measurement note in [[components/components]]). _Sources: [[12-06-2026-touchdown]]. See [[digests/touchdowns-12-17-jun-2026]]._
...
| Press releases will be staged strategically — tZERO, Sport Radar, Rebel/Novosapien — Skye working with new press release group | Edwin + Skye | Pending press group output |
...
- [ ] Stage press releases: tZERO partnership, tZERO advertising buy, Sport Radar partnership, Rebel/Novosapien partnership — exact sequence and dates TBD with Skye's new press release group
