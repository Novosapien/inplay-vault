...
>
> **Update (18–29 June touchdowns):** Site is **review-ready**. **Homepage** carries the **hype video embedded in a phone frame**; the rest of the homepage moved to a dedicated **How It Works** page (with a how-to-trade video). The **IPO pricing section is now an interactive calculator** (on-field expected wins vs ties vs trading-volume %), replacing a static formula. The **OG / social-share card image is the ugly default** — needs a designed asset (shared links currently look broken). **Referral program now runs through this site with full KYC** (launching ~July 4 week; the 600 signups get emailed). The **AI brand-preview tool** must be restored to the advertising page (Max — wanted for the Mastercard demo). **Legal (29-06):** terms / privacy / competition-rules pages are **AI-drafted and populated** (previously placeholders); they read well but **must be reviewed by counsel (Marlin / Matt Vogler) before publish** — exported to Word for redline. **Decision: disable the legal footer/links at go-live** until cleared (no prize-pool / regulatory claims live yet). **KYC opt-in** copy added to the signup. **Newsletter debate:** the first outreach leads with **action-first homepage/hype content** ($25M up top, referral CTA), with a fuller newsletter/community channel deferred. Standing rule holds: **"up to $25M", never "guaranteed"**. _Sources: [[24-06-2026-touchdown]], [[29-06-2026-touchdown]]. See [[digests/touchdowns-18-29-jun-2026]]._
