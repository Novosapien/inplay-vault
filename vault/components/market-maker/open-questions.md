...
| S9 | **Media tier or betting tier? The two accounts contradict (NEW 24-07)** — the SR service's own latency research puts the Probabilities product on the **media** feed (~5–15 s acquisition lag); Cody on the 24-07 touchdown said probabilities ride the **betting** feed and are fast. Both cannot be true, and which holds decides whether users watching DraftKings can pick the MM off (S4). Only settleable by **measuring against a real live game** (August) | MM integrity | 🔴 New — measure in August |
