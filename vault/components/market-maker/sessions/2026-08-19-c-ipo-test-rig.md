...
- **N67 opened** — the TxfrCost unit, which blocks the real seed.
...
1. **George's call on the 99,663 shares:** restore exactly, re-seed at a
   ...
   instrument that last traded at $63.88 — almost certainly N67's unit error at
   an earlier seed, so an exact restore restores nonsense.
2. **Settle N67 on IPLM** — one transfer, distinctive quantity, distinctive
