...
| Date | What happened |
|------|--------------|
| 2026-07-29 | tZERO (Evangelos) email confirming the IPO shares-outstanding decision (NCAA 1,000,000 / NFL 900,000, production-like to match a $75m cap), NCAA parallel 5-day offerings, NFL to simulate production. Ahead of the 30 Jul call. ([[29-07-2026-tzero-ipo-shares-email]]) |
| 2026-07-29 | **IPO Draft Business Requirements v2** (28 Jul, Edwin) stored + processed ([[ipo-draft-requirements]]): NCAA/NFL offering schedule, float updated to NCAA 1,000,000 / NFL 900,000 (retires the 5M float + 20% holdback), NFL 18 one-minute windows with pre-buy book + water line + MM completion sweep, 2,500-share per-participant cap. Supersedes the primary-offering/scheduling sub-component specs (re-spec flagged); five internal inconsistencies logged for v3. |
