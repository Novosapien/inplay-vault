...
edwin: Yeah. So basically that what that means group is that Baltimore is $140 favorite over the  
Cody Haugen: half.  
edwin: A's to win the game. So, if you want to win $100, you actually have to bet $140 to win a hundred. And then if you take the A's, I don't know. Are these guys on a nickel, dime, or 20 cent line?  
   
 
...
   
Brett StClair: The needle switched all the way through to the priority is 100% the advertiser and that's only because of I don't know if you've heard of the term in shitification right it applies even in the ad business so in shitification an example is Uber launches in a city prices of Uber are coming in under $10 for a trip you can buy an Uber X which is actually more like an Uber smart and it's really good quality car but over time price surges start surging more price surging actually's taken away you don't know when it's actually price surging. After a year, you suddenly that same trip is $25. And what they've done is they've laid in black. They've laid in all these additional services. So the goal is because the business is under pressure to grow 20% every single quarter to move the needle, but it gets to a point where you're sacrificing beyond what the experience is. And so in the world of media, that experience is you're now trading off because you need advertising dollar more than anything else.  
   
 
...
Skye Capazorio: Oh,  
edwin: Yeah. Okay. So, here here I've I've uh put in $150 to win  
Cody Haugen: up.  
edwin: $277. You know,  
Skye Capazorio: thanks.  
...
Cody Haugen: Um,  
edwin: regulators you know don't assume that we're a gambling product so and instead of saying like win up to $25 million it's earn up to $25 million like little words like that that take us from a skill-based competition which we're running  
Brett StClair: Yeah.  
