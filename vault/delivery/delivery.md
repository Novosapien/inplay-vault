...
|------|------|----------------|
| 2026-09-02 (v3) | [flight-plans/2026-09-02-inplay-app-flight-plan.html](flight-plans/2026-09-02-inplay-app-flight-plan.html) | **The Home graph is rebuilt around the right question, and it is now sourced from the requirement change register rather than from commit counts.** The previous version split commits by repository, which measured where work happened rather than what happened to the scope, and it told the wrong story. The graph now plots **the committed scope as a single block of 18 deliverables, agreed once in the July proposal and never moved**, against **every change InPlay made to a settled requirement, by the week the change was made**. Each amber point is a numbered register row with both citations. The finding is far sharper than the commit view: **eleven weeks from 6 May to 20 July with not one change to a settled requirement, then all 39 changes inside the final six weeks. Thirty-three of the 39 in the month before the offering, and eighteen of them, nearly half the total, in five days between 17 and 19 August**, nine of those on the 18th, the day after the freeze. The accompanying note keeps the fair half explicit: almost every change was defensible and several improved the product, the timing is the cost, and the behaviour is improving. It is now the argument for the NFL freeze. Label geometry verified programmatically: zero collisions, nothing clips |
