...
|------|------|----------------|
| 2026-09-08 | [flight-plans/2026-09-08-inplay-app-flight-plan.html](flight-plans/2026-09-08-inplay-app-flight-plan.html) | ⭐ **The launch programme is complete, and not one of its dates moved.** The NFL offering ran 5 to 6 September, secondary opened on the 7th, and the maker has quoted **all 170 books since 16:24Z on 7 September**, the first time both leagues have been live at once. Scorecard moves to **244% of committed scope on 99% of the planned time**, and critically the committed line closes at **18 of 18**: the eighteenth deliverable was the NFL window and it ran on the date the July proposal named. Delivered count 41 to 44, additional 20 to 22, the two new items being the **offering-beside-a-live-market mechanism** and the **crash-safety regime**. ✅ **The 27-08 structure reversal did not gate the date**: the NFL window ran on the NCAA structure that had already completed a live offering, exactly the fallback named on 2 September, and the restructure is now a Q1 conversation. Recorded as a method rather than a one-off. **Launch mode closes**, the build definition unfreezes, and the risk register changes character: it now describes operating a live market rather than building one. Two new operational risks from the first full week, both recorded with what was learned: the **6 to 7 September engine outage**, where a crash auto-restarted into a large journal replay and crawled for ~29 hours with stale quotes resting, now fixed so a crash stops the engine and the gateway sweeps its book in ten seconds; and the **end-of-game dark window**, seen twice on one Saturday, where the provider's status lag leaves a book dark for nine minutes or more at the final. Support model rises to high impact, because both incidents were caught only because the build team happened to be watching. ⚠ **Jared's 22 reference-data corrections are NOT delivered**, contrary to the brief: re-verified against every repo and branch on 8 September, all sixteen abbreviations are still wrong in `data/teams.ts` and Notre Dame still reads ACC. Together with the referral top-up, both now read **Due now** rather than logged, since the NFL launch they were deferred behind has completed |
