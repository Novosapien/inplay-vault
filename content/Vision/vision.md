...
| **Information / Bloomberg Terminal** | The data and intelligence layer — everything a trader needs to make decisions | News feed (AP-style from Sport Radar), market data (bid/ask, last price, order book depth), team pages (historical stats, upcoming matchups, player stats, price charts), game pages (live match tracker, interactive charts, real-time stats), large block trade alerts, leaderboards (3 verticals × daily/weekly/monthly/seasonal), favourites/following | Collecting |
